...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run unsupervised VVS models on MajajHong2015.')
    ...
    results.to_csv(f'results/majajhong2015_vvs_{args.regression}.csv', index=False)
